Locales['en'] = {
  ...
  -- Boss Menu
  ['boss_actions'] = 'press [E] to Boss Actions',
  -- Misc
  ['invalid_amount'] = 'Invalid amount',
  ['actions_prompt'] = 'Press [E] access the Ambulance Locker.',
  ['deposit_amount'] = 'Deposit Amount',
  ['money_withdraw'] = 'Amount withdrawn',
  ['fast_travel'] = 'press [E] to fast travel.',
  ['open_pharmacy'] = 'Press [E] to open the pharmacy.',
  ['open_storage'] = 'Press [E] to open Storage.',
  ...
  ['ems_menu_search'] = 'No Nearby Patient',
  -- Phone
