...
Config.Marker                     = {type = 20, x = 0.5, y = 0.5, z = 0.5, r = 152, g = 0, b = 102, a = 100, rotate = false}
...
Config.RespawnPoints = {
	{coords = vector3(322.0042, -570.4604, 43.2840), heading = 156.3652}
}
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(298.1841, -584.5851, 43.2609),
			sprite = 61,
			scale  = 0.8,
			color  = 2
		},
		StorageActions = {
			vector3(306.7619, -601.8140, 43.284)
		},

		AmbulanceActions = {
			vector3(300.5581, -597.4406, 43.2841)
		},

		Pharmacies = {
			vector3(310.1492, -568.5809, 43.2841)
		},
		BossActions = {
			vector3(334.7134, -593.5097, 43.2841)
		},	

	
		Vehicles = {
			{
				Spawner = vector3(296.4058, -604.8335, 43.2287),
				InsideShop = vector3(296.4058, -604.8335, 43.2287),
				Marker = {type = 36, x = 1.0, y = 1.0, z = 1.0, r = 100, g = 50, b = 200, a = 100, rotate = true},
				SpawnPoints = {
					{coords = vector3(297.3759, -605.2552, 43.2405), heading = 66.3055, radius = 4.0},
		...
		FastTravels = {
			{
				From = vector3(332.0259, -595.4617, 43.2841),
