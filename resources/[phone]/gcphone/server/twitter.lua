...
AddEventHandler('gcPhone:twitter_postTweets', function(username, password, message)
  ...
  TriggerClientEvent('co_notify:client:SendNotifys', -1, { app = "twitter" , title = "@"..username, content = message  })
...
AddEventHandler('gcPhone:twitter_newTweets', function (tweet)
  ...
  local discord_webhook = 'https://discord.com/api/webhooks/848065698726019083/GkB1i_nFJAy_qrI2Yf2X5CgHnXhvq6HO_4z0V9btPtnL9-Dtr5T976dE2SSHjDT8kzs2' -- Set Discord Webhook. See https://support.discord.com/hc/en-us/articles/228383668-Intro-to-Webhooks
