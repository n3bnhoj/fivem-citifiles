...
RegisterNetEvent('gcPhone:openPhonex')
AddEventHandler('gcPhone:openPhonex', function()
  TooglePhone()
end)
--====================================================================================
--  
...
RegisterNUICallback('faketakePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      ...
      exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/889177943853654036/cx6lODLf51JA5IfzBzNaVGKl2rIIxDW-lNabNAWPHEOB8LKYr9g4y-UhUcwlfMtHC0o7", "files[]", function(data)
        local image = json.decode(data)
        DestroyMobilePhone()
        CellCamActivate(false, false)
        cb(json.encode({ url = image.attachments[1].url }))   
        url2 = image.attachments[1].url
         TriggerServerEvent('addphoto', url2)
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      ...
      exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/900706337846079499/VtmLg6y39eq6NwXYn0cZOtfNYIYw7aqVZbjWm5koSx83lbTreDsqOfEoSRH1LyDke9pz", "files[]", function(data)
        local image = json.decode(data)
        DestroyMobilePhone()
        CellCamActivate(false, false)
        cb(json.encode({ url = image.attachments[1].url }))   
        TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 0.3, 'cuff', 0.7)	
